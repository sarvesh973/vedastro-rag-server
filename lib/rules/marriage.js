...
module.exports = [
...

  {
    ...
    prediction: {
      polarity: 'positive',
      text: 'Currently in Venus dasha or sub-period — period naturally favourable for marriage proposals, partnerships, romantic events.',
      timeframe: 'currentDasha',
    },
    predicate: (c) => {
      ...
      if (md === 'Venus' || ad === 'Venus') {
        return {
          matched: true,
          intensity: ad === 'Venus' && md === 'Venus' ? 9 : 7,
          evidence: `Current dasha: ${md}/${ad}`,
        };
      }
...

  {
    ...
    prediction: {
      polarity: 'positive',
      text: 'Dasha or bhukti of 7th-house lord active — classical primary trigger for marriage event.',
    ...
    predicate: (c) => {
      ...
      const md = c.dasha && c.dasha.mahadasha;
      const ad = c.dasha && c.dasha.antardasha;
      if (md !== l7 && ad !== l7) return { matched: false };
      return {
        matched: true,
        intensity: md === l7 && ad === l7 ? 10 : 8,
        evidence: `7th lord ${l7} active in dasha ${md}/${ad}`,
      };
    },
  },
