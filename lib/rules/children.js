...
module.exports = [
...

  {
    ...
    predicate: (c) => {
      ...
      return {
        matched: true,
        intensity: md === l && ad === l ? 10 : 8,
        evidence: `5th lord ${l} active in dasha ${md}/${ad}`,
      };
    },
  },

  {
    ...
    prediction: {
      polarity: 'positive',
      text: 'Jupiter dasha — putra-karaka period. Naturally favourable for conception and family expansion.',
      timeframe: 'currentDasha',
    },
    predicate: (c) => {
      const md = c.dasha && c.dasha.mahadasha;
      const ad = c.dasha && c.dasha.antardasha;
      if (md !== 'Jupiter' && ad !== 'Jupiter') return { matched: false };
      return {
        matched: true,
        intensity: md === 'Jupiter' ? 8 : 6,
        evidence: `Jupiter active in dasha ${md}/${ad}`,
      };
    },
  },
