...
module.exports = [
  ...
  },
  {
    ...
    prediction: { polarity: 'positive', text: 'Jupiter dasha — spiritual growth period. Drawn toward higher teachings, often a guru figure enters life, philosophical reading deepens.', timeframe: 'currentDasha' },
    predicate: (c) => {
  ...
  },
  {
    ...
    prediction: { polarity: 'mixed', text: 'Ketu dasha — material detachment period. Worldly ambitions feel hollow; pull toward solitude, meditation, philosophical questioning intensifies.', timeframe: 'currentDasha' },
    predicate: (c) => {
      const md = c.dasha && c.dasha.mahadasha;
      const ad = c.dasha && c.dasha.antardasha;
      if (md !== 'Ketu' && ad !== 'Ketu') return { matched: false };
      return { matched: true, intensity: md === 'Ketu' ? 8 : 6, evidence: `Ketu active in dasha ${md}/${ad}` };
    },
  },
  {
